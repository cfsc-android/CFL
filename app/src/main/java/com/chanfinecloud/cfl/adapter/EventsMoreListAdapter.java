 ...
 * Describe:
 */
public class EventsMoreListAdapter extends BaseQuickAdapter<EventsEntity, BaseViewHolder> {
    private Context context;
    private  int viewType;
    public EventsMoreListAdapter(Context context, List<EventsEntity> data) {
        super(R.layout.item_community_events_more,data);
