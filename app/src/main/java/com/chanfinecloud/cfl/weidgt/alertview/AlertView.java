package com.chanfinecloud.cfl.weidgt.alertview;
...
public class AlertView {
    ...
    protected void initViews(){
        ...
        switch (style){
            case ActionSheet:
                ...
                margin_alert_left_right = context.getResources().getDimensionPixelSize(R.dimen.dp_10);
            ...
            case Alert:
                ...
                margin_alert_left_right = context.getResources().getDimensionPixelSize(R.dimen.dp_40);
    ...
    public void setMarginBottom(int marginBottom){
        ...
        int margin_alert_left_right = context.getResources().getDimensionPixelSize(R.dimen.dp_40);
