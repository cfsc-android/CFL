package com.chanfinecloud.cfl.weidgt.easyindicator;
...
public class EasyIndicator extends LinearLayout implements View.OnClickListener, ViewPager.OnPageChangeListener {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (a != null) {
            ...
            indicator_bottom_line_color = a.getColor(R.styleable.EasyIndicator_indicator_bottom_line_color, getResources().getColor(R.color.blue_color));
            indicator_selected_color = a.getColor(R.styleable.EasyIndicator_indicator_selected_color, getResources().getColor(R.color.blue_color));
            indicator_normal_color = a.getColor(R.styleable.EasyIndicator_indicator_normal_color, getResources().getColor(R.color.blue_color_light));
            indicator_line_color = a.getColor(R.styleable.EasyIndicator_indicator_line_color, getResources().getColor(R.color.blue_color));
            ...
            indicator_vertical_line_color = a.getColor(R.styleable.EasyIndicator_indicator_vertical_line_color, getResources().getColor(R.color.blue_color_light));
     ...
     * @param adapter
     */
    public void setViewPager(ViewPager viewPage, FragmentPagerAdapter adapter) {
        mViewPager = viewPage;
        mViewPager.setAdapter(adapter);
        mViewPager.setCurrentItem(0);
        mViewPager.addOnPageChangeListener(this);
