package com.chanfinecloud.cfl.weidgt.imagepreview.ui;
...
import com.chanfinecloud.cfl.weidgt.imagepreview.IPreviewInfo;
import com.chanfinecloud.cfl.weidgt.imagepreview.MediaLoader;
import com.chanfinecloud.cfl.weidgt.imagepreview.loader.ISimpleTarget;
import com.chanfinecloud.cfl.weidgt.imagepreview.loader.OnVideoClickListener;
import com.chanfinecloud.cfl.weidgt.imagepreview.photoview.PhotoViewAttacher;
import com.chanfinecloud.cfl.weidgt.imagepreview.view.SmoothImageView;


/**
 * Created by Loong on 2020/2/18.
 * Version: 1.0
 * Describe:  图片预览单个图片的fragment
 */
public class BasePhotoFragment extends Fragment {
    /**
     * 预览图片 类型
     */
    public static final String KEY_TRANS_PHOTO = "com.findingdata.oabank.KEY_TRANS_PHOTO";
    public static final String KEY_SING_FILING = "com.findingdata.oabank.KEY_SING_FILING";
    public static final String KEY_PREVIEW_ITEM = "com.findingdata.oabank.KEY_PREVIEW_ITEM";
    public static final String KEY_DRAG = "com.findingdata.oabank.KEY_DRAG";
    public static final String KEY_SENSITIVITY = "com.findingdata.oabank.KEY_SENSITIVITY";
