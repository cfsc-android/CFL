...
import com.chanfinecloud.cfl.weidgt.wheelview.adapter.WheelViewAdapter;
...
public class WheelView extends View {
    ...
    private void drawCenterRect(Canvas canvas) {
        ...
        /*
         * / Remarked by wulianghuan 2014-11-27 使用自己的画线，而不是描边 Rect rect = new Rect(left, top, right, bottom)
